...
Usage:
    python cli/validate_dataset.py --audio_dir data/chunked/audio --text_dir data/chunked/text
"""
...
def main():
    ...
    parser.add_argument('--audio_dir', type=str, default='data/chunked/audio', help='Directory with audio chunks')
    parser.add_argument('--text_dir', type=str, default='data/chunked/text', help='Directory with transcript chunks')
