...
def build_context(root: Optional[Path] = None) -> Dict[str, Any]:
    ...
    ctx = {
        ...
        # Backward-compatible alias kept for modules that still read RUN_V2_DIR.
        "RUN_V2_DIR": run_v1_dir,
        ...
        # Deprecated aliases now point to primary large-run artifacts.
        "V2_BASELINE_METRICS": v1_metrics_dir / "baseline_holdout_metrics.json",
        "V2_FINETUNED_METRICS": v1_metrics_dir / "finetuned_holdout_metrics.json",
        "V2_BASELINE_PRED": v1_metrics_dir / "baseline_holdout_predictions.jsonl",
        "V2_FINETUNED_PRED": v1_metrics_dir / "finetuned_holdout_predictions.jsonl",
    }
